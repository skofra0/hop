...
public class LogChannelFileWriter {
  ...
  /**
   * Start the logging thread which will write log data from the specified log channel to the log
   * file. In case of an error, the exception will be available with method getException().
   */
