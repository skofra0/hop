...
public class PipelinePainterExtension {
  ...
  public PipelinePainterExtension(IGc gc, List<AreaOwner> areaOwners, PipelineMeta pipelineMeta, TransformMeta transformMeta, PipelineHopMeta pipelineHop, int x1, int y1, int x2, int y2, int mx, int my, Point offset, int iconSize, Map<String, Object> stateMap) {
    super();
    this.gc = gc;
