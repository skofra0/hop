...
/**
 * IRowListener is a listener interface for receiving row events. A class that is interested in
...
public interface IRowListener {
  ...
  /**
   * This method is called when a row is written to another transform (even if there is no next
   * transform)
   *
   * @param rowMeta the metadata of the row
   * @param row the data of the row
