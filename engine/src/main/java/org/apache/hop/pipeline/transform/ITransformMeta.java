 ...
 *
 * <ul>
 * <li><b>Keep track of the transform settings</b></br>
 * The implementing class typically keeps
 ...
 * <p>
 * This method is called every time a new transform is created and should allocate or set
 ...
 * <p>
 * This method is called when a transform is duplicated in HopGui. It needs to return a
 ...
 * <p>
 * This method is called by Apache Hop whenever a transform needs to serialize its settings
 ...
 * <p>
 * This method is called by Apache Hop whenever a transform needs to read its settings from
 ...
 * <p>
 * Each of the above methods returns a new instance of the plugin class implementing
 ...
 * <p>
 * Given a description of the input rows, the plugin needs to modify it to match the
 ...
 * <p>
 * <i><a href= "#check(java.util.List, org.apache.hop.pipeline.PipelineMeta,
 ...
 * check()</a></i>
 * <p>
 * Each transform has the opportunity to validate its settings and verify that the
...
public interface ITransformMeta {
   ...
   */
  void getFields(IRowMeta inputRowMeta, String name, IRowMeta[] info, TransformMeta nextTransform, IVariables variables, IHopMetadataProvider metadataProvider)
   ...
   */
  SqlStatement getSqlStatements(IVariables variables, PipelineMeta pipelineMeta, TransformMeta transformMeta, IRowMeta prev, IHopMetadataProvider metadataProvider)
      throws HopTransformException;
   ...
   */
  String exportResources(IVariables variables, Map<String, ResourceDefinition> definitions, IResourceNaming iResourceNaming, IHopMetadataProvider metadataProvider)
      throws HopException;
   ...
   *
   * <p>
   * Sometimes, in addition to the hops themselves, a Transform has internal configuration
  ...
  final class TransformFactory implements IHopMetadataObjectFactory {
    ...
    public Object createObject(String id, Object parentObject) throws HopException {
      return PluginRegistry.getInstance().loadClass(TransformPluginType.class, id, ITransformMeta.class);
    }
