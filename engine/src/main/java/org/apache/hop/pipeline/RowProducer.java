...
public class RowProducer {
  ...
  /**
   * Puts a row on to the underlying row set, optionally blocking until the row can be successfully
   * put.
   *
  ...
  /**
   * Signal that we are done producing rows. It will allow the transform to which this producer is
   * attached to know that no more rows are forthcoming.
   */
