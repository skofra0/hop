...
public class SocketPortAllocation {
  ...
  public SocketPortAllocation(int port, Date lastRequested, String clusterRunId, String pipelineName, String sourceServerName, String sourceTransformName, String sourceTransformCopy, String targetServerName, String targetTransformName, String targetTransformCopy) {
    this.port = port;
