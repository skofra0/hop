...
public class WebServer {
  ...
  public WebServer(ILogChannel log, PipelineMap pipelineMap, WorkflowMap workflowMap, String hostname, int port, boolean join, String passwordFile) throws Exception {
    this(log, pipelineMap, workflowMap, hostname, port, join, passwordFile, null);
  }

  public WebServer(ILogChannel log, PipelineMap pipelineMap, WorkflowMap workflowMap, String hostname, int port, boolean join, String passwordFile, SslConfiguration sslConfig) throws Exception {
    this.log = log;
