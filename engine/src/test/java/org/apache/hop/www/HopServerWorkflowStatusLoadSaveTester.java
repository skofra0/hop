...
public class HopServerWorkflowStatusLoadSaveTester extends LoadSaveBase<HopServerWorkflowStatus> {
  ...
  public HopServerWorkflowStatusLoadSaveTester(Class<HopServerWorkflowStatus> clazz, List<String> attributes, Map<String, IFieldLoadSaveValidator<?>> fieldLoadSaveValidatorAttributeMap) throws HopException {
