 ...
 *
 * <p>
 * The goal of this test is to verify that attributes from one BaseRowSet doesn't mix with
 ...
 *
 * <p>
 * Then mutator mutates blockingRowSet by calling: {@link
 * org.apache.hop.core.BaseRowSet#setThreadNameFromToCopy(String, int, String, int)}. where all
 * inputs have the same id.
 *
 * <p>
 * It is expected that shared blockingRowSet will always be in consistent state (all his fields
...
public class BaseRowSetConcurrentTest {
  ...
  private class Getter extends StopOnErrorCallable<Object> {
     ...
     *
     * <p>
     * Example: input -> 123-124 output -> set with values "123", "124" in it.
     */
