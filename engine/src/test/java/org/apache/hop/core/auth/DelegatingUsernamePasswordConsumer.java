...
public class DelegatingUsernamePasswordConsumer implements IAuthenticationConsumer<Object, UsernamePasswordAuthenticationProvider> {
  private IAuthenticationConsumer<Object, UsernamePasswordAuthenticationProvider> delegate;

  public DelegatingUsernamePasswordConsumer(IAuthenticationConsumer<Object, UsernamePasswordAuthenticationProvider> delegate) {
