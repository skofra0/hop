...
public class DatabaseImpactTest {
  ...
  public void testGetRow() throws HopValueException {
    DatabaseImpact testObject = new DatabaseImpact(DatabaseImpact.TYPE_IMPACT_READ, "myPipeline", "aTransform", "ProdDB", "DimCustomer", "Customer_Key", "MyValue", "Calculator 2", "SELECT * FROM dimCustomer", "Some remarks");
    ...
    assertEquals(BaseMessages.getString(PKG, "DatabaseImpact.RowDesc.Label.Pipeline"), rmd.getValueMeta(1).getName());
