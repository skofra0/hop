...
public class TransformLoadSaveTester<T extends ITransformMeta> extends LoadSaveBase<T> {
  ...
  public TransformLoadSaveTester(Class<T> clazz, List<String> xmlAttributes, Map<String, String> getterMap, Map<String, String> setterMap, Map<String, IFieldLoadSaveValidator<?>> fieldLoadSaveValidatorAttributeMap, Map<String, IFieldLoadSaveValidator<?>> fieldLoadSaveValidatorTypeMap)
      throws HopException {
    super(clazz, xmlAttributes, getterMap, setterMap, fieldLoadSaveValidatorAttributeMap, fieldLoadSaveValidatorTypeMap);
  }

  public TransformLoadSaveTester(Class<T> clazz) throws HopException {
