...
public class TransformErrorMetaTest {
  ...
  public void testGetErrorRowMeta() {
    ...
    TransformErrorMeta testObject = new TransformErrorMeta(new TransformMeta(), new TransformMeta(), "${VarNumberErrors}", "${VarErrorDescription}", "${VarErrorFields}", "${VarErrorCodes}");
