...
public class BaseTransformTest {
  ...
  public void testBaseTransformGetLogLevelWontThrowNPEWithNullLog() {
    ...
    new BaseTransform<ITransformMeta, ITransformData>(
  ...
  public void testTransformListenersConcurrentModification() throws InterruptedException {
    ...
    final BaseTransform<ITransformMeta, ITransformData> baseTransform = new BaseTransform<>(mockHelper.transformMeta, mockHelper.iTransformMeta, mockHelper.iTransformData, 0, mockHelper.pipelineMeta, mockHelper.pipeline);
  ...
  public void resultFilesMapIsSafeForConcurrentModification() throws Exception {
    final BaseTransform<ITransformMeta, ITransformData> transform = new BaseTransform<>(mockHelper.transformMeta, mockHelper.iTransformMeta, mockHelper.iTransformData, 0, mockHelper.pipelineMeta, mockHelper.pipeline);
  ...
  public void outputRowMetasAreNotSharedAmongSeveralStreams() throws Exception {
    ...
    BaseTransform<ITransformMeta, ITransformData> baseTransform = new BaseTransform<>(mockHelper.transformMeta, mockHelper.iTransformMeta, mockHelper.iTransformData, 0, mockHelper.pipelineMeta, mockHelper.pipeline);
  ...
  public void putRowWithRowHandler() throws HopException {
    BaseTransform baseTransform = new BaseTransform<>(mockHelper.transformMeta, mockHelper.iTransformMeta, mockHelper.iTransformData, 0, mockHelper.pipelineMeta, mockHelper.pipeline);
    baseTransform.setRowHandler(rowHandler);
