...
:language: en_US
:description: The Salesforce Update transform updates records directly in your Salesforce database using the Salesforce Web Service.

= image:transforms/icons/SFUD.svg[Salesforce Update transform Icon, role="image-doc-icon"] Salesforce Update
...
* Transform name: Specifies the unique name of the Salesforce Update transform on the canvas.
