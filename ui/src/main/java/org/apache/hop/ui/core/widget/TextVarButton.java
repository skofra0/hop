...
public class TextVarButton extends TextVar {
  ...
  public TextVarButton(IVariables variables, Composite composite, int flags, IGetCaretPosition getCaretPositionInterface, IInsertText insertTextInterface, SelectionListener selectionListener) {
