...
import org.apache.hop.ui.core.widget.highlight.JavaScriptHighlight;
...
public class JavaScriptStyledTextComp extends TextComposite {
  private static final Class<?> PKG = JavaScriptStyledTextComp.class;
  ...
  public JavaScriptStyledTextComp(IVariables variables, Composite parent, int args) {
    this(variables, parent, args, true, false);
  }

  public JavaScriptStyledTextComp(
