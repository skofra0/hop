...
public class TabCloseHandler {
  ...
  public TabCloseHandler(TabClosable tabClosablePerspective) {
    ...
    miClose.addListener(SWT.Selection, event -> tabClosablePerspective.closeTab(null, selectedItem));
    ...
    miCloseOthers.addListener(SWT.Selection, event -> tabClosablePerspective.getOtherTabs(selectedItem).forEach(tabItem -> tabClosablePerspective.closeTab(null, tabItem)));
    ...
    miCloseLeft.setText(BaseMessages.getString(PKG, "DataOrchestrationPerspective.CloseLeft.Button.Text"));
    miCloseLeft.addListener(SWT.Selection, event -> tabClosablePerspective.getTabsToLeft(selectedItem).forEach(tabItem -> tabClosablePerspective.closeTab(null, tabItem)));

    MenuItem miCloseRight = new MenuItem(menu, SWT.NONE);
    miCloseRight.setText(BaseMessages.getString(PKG, "DataOrchestrationPerspective.CloseRight.Button.Text"));
    miCloseRight.addListener(SWT.Selection, event -> tabClosablePerspective.getTabsToRight(selectedItem).forEach(tabItem -> tabClosablePerspective.closeTab(null, tabItem)));
  }
