...
public class PipelineDialog extends Dialog {
  ...
  public enum Tabs {
    PIPELINE_TAB, PARAM_TAB, MONITOR_TAB, EXTRA_TAB,
  }
  ...
  public PipelineMeta open() {
    ...
    for (IPlugin pipelineDialogPlugin : pipelineDialogPlugins) {
      try {
        ...
        new ErrorDialog(shell, BaseMessages.getString(PKG, "PipelineDialog.LoadDialogPlugin.Error.Header"), BaseMessages.getString(PKG, "PipelineDialog.LoadDialogPlugin.Error.Message", pipelineDialogPlugin.getIds()[0]), e);
      }
    }
