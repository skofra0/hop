...
public class BeamDefaults {
  ...
  public static final String[] PUBSUB_MESSAGE_TYPES =
      new String[] {
  ...
  public static final String[] WINDOW_TYPES = new String[] {WINDOW_TYPE_FIXED, WINDOW_TYPE_SLIDING, WINDOW_TYPE_SESSION, WINDOW_TYPE_GLOBAL};
}
