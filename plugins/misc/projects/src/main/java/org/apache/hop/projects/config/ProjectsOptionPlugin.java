...
public class ProjectsOptionPlugin implements IConfigOptions {
  ...
  public static final boolean configure(ILogChannel log, IVariables variables, IHasHopMetadataProvider hasHopMetadataProvider, String projectName, String environmentName)
      throws HopException {
