...
@ExtensionPoint(
    ...
    description =
        "When HopGui opens a new file it presents a dialog. We want to set the default folder to the project home folder")
public class HopGuiFileOpenSetDefaultFolder extends HopGuiFileDefaultFolder
