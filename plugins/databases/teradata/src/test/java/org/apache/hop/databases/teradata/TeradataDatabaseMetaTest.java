...
public class TeradataDatabaseMetaTest {
  ...
  public void testSettings() {
    ...
    assertEquals(
        "http://www.info.ncr.com/eTeradata-BrowseBy-Results.cfm?pl=&PID=&title=%25&release="
  ...
  public void testGetFieldDefinition() {
    ...
    assertEquals(
        ...
        nativeMeta.getFieldDefinition(
            new ValueMetaBigNumber("FOO", 10, 0), "", "", false, false, false));
    ...
    assertEquals(
        "INTEGER",
        nativeMeta.getFieldDefinition(
            new ValueMetaBigNumber("FOO", 9, 0), "", "", false, false, false));
    assertEquals(
        "SMALLINT",
        nativeMeta.getFieldDefinition(
            new ValueMetaBigNumber("FOO", 3, 0), "", "", false, false, false));
    assertEquals(
        "SMALLINT",
        nativeMeta.getFieldDefinition(
            new ValueMetaBigNumber("FOO", 4, 0), "", "", false, false, false));
    assertEquals(
        "SMALLINT",
        nativeMeta.getFieldDefinition(
    ...
    assertEquals(
        "BYTEINT",
        nativeMeta.getFieldDefinition(
            new ValueMetaBigNumber("FOO", 2, 0), "", "", false, false, false));
    assertEquals(
        "BYTEINT",
        nativeMeta.getFieldDefinition(
            new ValueMetaBigNumber("FOO", 1, 0), "", "", false, false, false));

    assertEquals(
        "DOUBLE PRECISION",
        nativeMeta.getFieldDefinition(
            new ValueMetaInteger("FOO", -23, 0), "", "", false, false, false));

    assertEquals(
        "CLOB",
        nativeMeta.getFieldDefinition(
            new ValueMetaString("FOO", 64001, 0), "", "", false, false, false));
    assertEquals(
        "VARCHAR(64000)",
        nativeMeta.getFieldDefinition(
            new ValueMetaString("FOO", 64000, 0), "", "", false, false, false));
    assertEquals(
        "VARCHAR(1)",
        nativeMeta.getFieldDefinition(
