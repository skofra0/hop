...
public class TeradataDatabaseMetaTest {
  ...
  public void testSqlStatements() {
    ...
    assertEquals("SELECT * FROM DBC.columns WHERE tablename =BAR AND columnname =FOO", nativeMeta.getSqlColumnExists("FOO", "BAR")); // Likely a bug - table/column not quoted.
