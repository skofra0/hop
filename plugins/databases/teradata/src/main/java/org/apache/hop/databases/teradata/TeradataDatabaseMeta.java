...
public class TeradataDatabaseMeta extends BaseDatabaseMeta implements IDatabase {
  ...
  public String getSqlColumnExists(String columnname, String tableName) {
    return "SELECT * FROM DBC.columns WHERE tablename ="
        + tableName
        + " AND columnname ="
        + columnname;
  }
  ...
  /**
   * Overrides parent behavior to allow <code>getDatabasePortNumberString</code> value to override
   * value of <code>DBS_PORT</code> extra option.
   */
  @Override
