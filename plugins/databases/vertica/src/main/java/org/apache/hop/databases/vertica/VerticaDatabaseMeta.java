...
public class VerticaDatabaseMeta extends BaseDatabaseMeta implements IDatabase {
  ...
  /*
   *
   * https://www.vertica.com/docs/9.2.x/HTML/Content/Authoring/SQLReferenceManual/DataTypes/
   * LongDataTypes.htm
   *
   */
  ...
  public String getAddColumnStatement(String tableName, IValueMeta v, String tk, boolean useAutoinc, String pk, boolean semicolon) {
    return "--NOTE: Table cannot be altered unless all projections are dropped.\nALTER TABLE " + tableName + " ADD " + getFieldDefinition(v, tk, pk, useAutoinc, true, false);
  }
