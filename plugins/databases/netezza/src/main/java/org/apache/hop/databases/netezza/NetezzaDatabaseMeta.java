...
public class NetezzaDatabaseMeta extends BaseDatabaseMeta implements IDatabase {
  ...
  public String getSqlSequenceExists(String sequenceName) {
    return "SELECT seqname AS sequence_name from _v_sequence where seqname = '"
  ...
  /**
   * Generates the SQL statement to add a column to the specified table Note: Netezza does not allow
  ...
  /**
   * Generates the SQL statement to drop a column from the specified table Note: Netezza does not
   * allow addition/deletion of columns to tables
   *
   * @param tableName The table to add
   * @param v The column defined as a value
   * @param tk the name of the technical key field
  ...
  /**
   * Generates the SQL statement to modify a column in the specified table. Note: Support for this
   * in Netezza is incomplete since Netezza allows very limited table/column modifications
   * post-creation
   *
   * @param tableName The table to add
   * @param v The column defined as a value
  ...
  public String getModifyColumnStatement(
    ...
    String retval = "";
    retval +=
        "ALTER TABLE " + tableName + " MODIFY COLUMN " + v.getName() + Const.CR + ";" + Const.CR;
    return retval;
  }
