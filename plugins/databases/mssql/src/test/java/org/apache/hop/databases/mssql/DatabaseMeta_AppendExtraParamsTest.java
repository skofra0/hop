...
public class DatabaseMeta_AppendExtraParamsTest {
   ...
   * 
   * doCallRealMethod().when( meta ).appendExtraOptions( anyString(), anyMapOf( String.class,
   * String.class ) );
   ...
   * by point, extra option is considered to be invalid
   */
  /*
   * @Test
   ...
   * STRING_EXTRA_OPTION + 0 + mssqlServerDatabaseMeta.getExtraOptionValueSeparator() +
   * STRING_OPTION_VALUE + 0;
   * String expectedUrl =
   * CONN_URL_NO_EXTRA_OPTIONS + mssqlServerDatabaseMeta.getExtraOptionSeparator() +
   * expectedExtraOptionsUrl;
   * 
   * String connUrlWithExtraOptions = meta.appendExtraOptions( CONN_URL_NO_EXTRA_OPTIONS, extraOptions
   * );
   ...
   * extra options generated by this method are valid.</b>
   */
  /*
