...
public class MySqlDatabaseMetaTest {
  ...
  public void testSqlStatements() {
    ...
    assertEquals(
        "ALTER TABLE FOO ADD BAR MEDIUMTEXT", nativeMeta.getAddColumnStatement("FOO", new ValueMetaString("BAR", nativeMeta.getMaxVARCHARLength() + 2, 0), "", false, "", false));
  ...
  public void testExtraOptions() {
    DatabaseMeta nativeMeta = new DatabaseMeta("", "MYSQL", "JDBC", null, "stub:stub", null, null, null);
