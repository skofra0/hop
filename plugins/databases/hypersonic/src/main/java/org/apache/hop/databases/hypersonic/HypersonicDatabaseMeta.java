...
public class HypersonicDatabaseMeta extends BaseDatabaseMeta implements IDatabase {
  ...
  public String getSqlCurrentSequenceValue(String sequenceName) {
    ...
    // anywhere
    return "SELECT " + sequenceName + ".currval FROM INFORMATION_SCHEMA.SYSTEM_SEQUENCES WHERE SEQUENCE_NAME = '" + sequenceName + "'";
  }
  ...
  public String getSqlNextSequenceValue(String sequenceName) {
    return "SELECT NEXT VALUE FOR " + sequenceName + " FROM INFORMATION_SCHEMA.SYSTEM_SEQUENCES WHERE SEQUENCE_NAME = '" + sequenceName + "'";
  }
}
