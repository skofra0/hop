...
public class KingbaseESDatabaseMeta extends BaseDatabaseMeta implements IDatabase {
  ...
  public String getModifyColumnStatement(String tableName, IValueMeta v, String tk, boolean useAutoinc, String pk, boolean semicolon) {
    ...
    retval += "ALTER TABLE " + tableName + " ADD COLUMN " + getFieldDefinition(v, tk, pk, useAutoinc, true, false);
    return retval;
  }
  ...
  public String getSqlListOfProcedures() {
    return "select proname " + "from sys_proc, sys_user " + "where sys_user.usesysid = sys_proc.proowner " + "and upper(sys_user.usename) = '" + getUsername().toUpperCase() + "'";
  }
  ...
  /**
   * @return true if the database supports timestamp to date conversion. Kingbase doesn't support
   *         this!
   */
  @Override
