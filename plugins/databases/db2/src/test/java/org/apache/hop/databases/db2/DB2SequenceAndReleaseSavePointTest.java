...
public class DB2SequenceAndReleaseSavePointTest {
  ...
  public void testSequenceSupport() {
    ...
    assertEquals(
        ...
        db.getSqlNextSequenceValue(sequenceName));
    assertEquals(
        "SELECT PREVIOUS VALUE FOR sequence_name FROM SYSIBM.SYSDUMMY1",
        db.getSqlCurrentSequenceValue(sequenceName));
  }
