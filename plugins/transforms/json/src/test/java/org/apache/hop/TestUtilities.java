...
public class TestUtilities {
  ...
  /**
   * Return the file format based on the OS type. We set the file format to DOS if it is Windows
   * since that is the only Windows file type that shows up in the TextFileInput dialog.
   *
  ...
  public static Pipeline loadAndRunPipeline(String path, Object... parameters) throws Exception {
    PipelineMeta pipelineMeta = new PipelineMeta(path, new MemoryMetadataProvider(), Variables.getADefaultVariableSpace());
