...
public enum FakerType {
  ...
  // LordOfTheRings(com.github.javafaker.LordOfTheRings.class, "lordOfTheRings", "Lord of the
  // rings"),
  ...
  // HitchhikersGuideToTheGalaxy(com.github.javafaker.HitchhikersGuideToTheGalaxy.class,
  // "hitchhikersGuideToTheGalaxy", "Hitchhikers guide to the galaxy"),
  // Hobbit(com.github.javafaker.Hobbit.class, "hobbit", "Hobbit"),
  // HowIMetYourMother(com.github.javafaker.HowIMetYourMother.class, "howIMetYourMother", "How I met
  // your mother"),
  // LeagueOfLegends(com.github.javafaker.LeagueOfLegends.class, "leagueOfLegends", "League of
  // Legends"),
  ...
  // BackToTheFuture(com.github.javafaker.BackToTheFuture.class, "backToTheFuture", "Back to the
  // future"),
  ...
  // AquaTeenHungerForce(com.github.javafaker.AquaTeenHungerForce.class, "aquaTeenHungerForce",
