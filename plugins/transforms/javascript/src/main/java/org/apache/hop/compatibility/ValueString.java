...
public class ValueString implements IValue, Cloneable {
  private String string;
  private int length;

  private static final ThreadLocal<SimpleDateFormat> LOCAL_SIMPLE_DATE_PARSER = new ThreadLocal<>() {
    @Override
  ...
  public long getInteger() {
    return Const.toLong(Const.ltrim(string), 0L); // Remove the leading space to make "int to string
                                                  // to int"
                                                  // conversion possible.
  }
