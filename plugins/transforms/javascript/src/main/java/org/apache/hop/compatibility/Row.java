...
public class Row implements IXml, Comparable<Row>, Serializable {
   ...
   * (same name and same
   * type) and have non-empty values will have their values written into this row, if the value of
   * that field is empty
   * in this row.
   * @param r
   *        The row to be merged with this row
   ...
   *        The DataInputStream to read from
   * @param meta
   *        The description (name, type, length, precision) of the values to be read (the same
   ...
   * @param ascending
   *        an entry for each value to compare where true means and normal compare, false the
   *        reverse.
