...
public class TableInputVariableDialog extends BaseTransformDialog {
  ...
  public TableInputVariableDialog(
      Shell parent,
  ...
  public String open() {
    ...
    colinf[0] =
        new ColumnInfo(
            BaseMessages.getString(PKG, "TableInputVariableDialog.Fields.Column.FieldName"),
            ColumnInfo.COLUMN_TYPE_CCOMBO,
            new String[] {""},
            false);
    colinf[1] =
        new ColumnInfo(
            BaseMessages.getString(PKG, "TableInputVariableDialog.Fields.Column.VariableName"),
            ColumnInfo.COLUMN_TYPE_TEXT,
            false);
    colinf[2] =
        new ColumnInfo(
            BaseMessages.getString(PKG, "TableInputVariableDialog.Fields.Column.DefaultValue"),
            ColumnInfo.COLUMN_TYPE_TEXT,
            false);
    colinf[2].setUsingVariables(true);
    colinf[2].setToolTip(
        BaseMessages.getString(PKG, "TableInputVariableDialog.Fields.Column.DefaultValue.Tooltip"));
      ...
      if (transformMeta != null) {
        ...
        if (r != null && !r.isEmpty()) {
          BaseTransformDialog.getFieldsFromPrevious(
              ...
              -1,
              -1,
              (TableItem tableItem, IValueMeta v) -> {
