...
public class TransformMockUtil {
  ...
  public static <T extends ITransformMeta, V extends BaseTransform, D extends ITransformData> TransformMockHelper<T, D> getTransformMockHelper(
      Class<T> meta,
      Class<D> data,
      String name) {
  ...
  public static <T extends BaseTransform, K extends ITransformMeta, D extends ITransformData> T getTransform(
