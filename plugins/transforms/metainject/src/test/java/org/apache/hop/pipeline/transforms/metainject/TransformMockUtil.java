...
public class TransformMockUtil {
  ...
  public static MetaInject getTransform(Class<MetaInject> klass, TransformMockHelper mock)
    ...
    Constructor<MetaInject> kons = klass.getConstructor(TransformMeta.class, MetaInjectMeta.class, MetaInjectData.class, int.class, PipelineMeta.class, Pipeline.class);
