...
public enum SystemDataTypes {
  ...
  TYPE_SYSTEM_INFO_WORKFLOW_DATE_FROM("workflow start date range", "JobStartDateRange"),
  TYPE_SYSTEM_INFO_WORKFLOW_DATE_TO("workflow end date range", "JobEndDateRange"),
