...
public class IfNullMetaTest {
  ...
  public void testLoadSaveValueType() throws Exception {
    IfNullMeta meta = TransformSerializationTestUtil.testSerialization("/if-null-transform-value-type.xml", IfNullMeta.class);
  ...
  public void testLoadSaveField() throws Exception {
    IfNullMeta meta = TransformSerializationTestUtil.testSerialization("/if-null-transform-field.xml", IfNullMeta.class);
