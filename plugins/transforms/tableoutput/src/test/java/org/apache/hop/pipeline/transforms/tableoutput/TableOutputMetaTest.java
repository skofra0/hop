...
public class TableOutputMetaTest {
  ...
  public void testSerialization() throws Exception {
    ...
    factory.registerValidator(
        TableOutputMeta.class.getDeclaredField("fields").getGenericType().toString(), new ListLoadSaveValidator<>(new TableOutputFieldInputFieldLoadSaveValidator()));

    tester.testSerialization();
  }

  public class TableOutputFieldInputFieldLoadSaveValidator implements IFieldLoadSaveValidator<TableOutputField> {
    ...
    public TableOutputField getTestObject() {
      ...
      TableOutputField field = new TableOutputField(UUID.randomUUID().toString(), UUID.randomUUID().toString());
    ...
    public boolean validateTestObject(TableOutputField testObject, Object actual) {
      ...
      return new EqualsBuilder().append(testObject.getFieldStream(), another.getFieldStream()).append(testObject.getFieldDatabase(), another.getFieldDatabase()).isEquals();
    }
  }
}
