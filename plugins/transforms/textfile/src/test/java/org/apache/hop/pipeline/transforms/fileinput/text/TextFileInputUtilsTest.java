...
public class TextFileInputUtilsTest {
  ...
  public void guessStringsFromLine() throws Exception {
    ...
    String[] strings = TextFileInputUtils.guessStringsFromLine(Mockito.mock(IVariables.class), Mockito.mock(ILogChannel.class), line, inputMeta, "|", "\"", "\\");
  ...
  public void convertLineToStrings() throws Exception {
    ...
    String[] strings = TextFileInputUtils.convertLineToStrings(Mockito.mock(ILogChannel.class), line, inputMeta, "|", "\"", "\\");
    Assert.assertNotNull(strings);
  ...
  public void convertCSVLinesToStrings() throws Exception {
    ...
    strings = TextFileInputUtils.convertLineToStrings(Mockito.mock(ILogChannel.class), line, inputMeta, ",", "", "\\");
    Assert.assertNotNull(strings);
