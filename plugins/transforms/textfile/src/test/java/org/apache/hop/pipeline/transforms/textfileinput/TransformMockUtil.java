...
public class TransformMockUtil {
  ...
  public static <
          Meta extends ITransformMeta, Main extends BaseTransform, Data extends ITransformData>
  ...
  public static TextFileInput getTransform(
      TextFileInputMeta meta, TextFileInputData data, String test) {
    return new TextFileInput(
        Mockito.mock(TransformMeta.class),
        meta,
        data,
        0,
        Mockito.mock(PipelineMeta.class),
  ...
  public static <
    ...
    TransformMockHelper<Meta, Data> mockHelper =
        org.apache.hop.pipeline.transforms.fileinput.text.TransformMockUtil.getTransformMockHelper(
            metaClass, dataClass, transformName);
