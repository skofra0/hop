...
public class TransformMockUtil {
  ...
  public static <Meta extends ITransformMeta, Main extends BaseTransform, Data extends ITransformData> TransformMockHelper<Meta, Data> getTransformMockHelper(
      Class<Meta> meta,
      Class<Data> data,
      String name) {
  ...
  public static <Main extends BaseTransform, Meta extends ITransformMeta, Data extends ITransformData> Main getTransform(
      ...
      TransformMockHelper<Meta, Data> mock)
