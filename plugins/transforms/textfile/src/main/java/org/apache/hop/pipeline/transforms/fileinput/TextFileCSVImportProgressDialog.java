...
public class TextFileCSVImportProgressDialog implements ICsvInputAwareImportProgressDialog {
   ...
   */
  public TextFileCSVImportProgressDialog(Shell shell, IVariables variables, IInputFileMeta meta, PipelineMeta pipelineMeta, InputStreamReader reader, int samples,
      boolean replaceMeta) {
    this.shell = shell;
    ...
    while (!errorFound && line != null && (linenr <= samples || samples == 0) && !monitor.isCanceled()) {
      ...
      Object[] r =
          TextFileInput.convertLineToRow(
              log, new TextFileLine(line, fileLineNumber, null), strinfo, null, 0, outputRowMeta, convertRowMeta, meta.getFilePaths(variables)[0], rownumber, delimiter, enclosure,
              escapeCharacter, null, false, false, false, false, false, false, false, false, null, null, false, null, null, null, null, 0, failOnParseError);
