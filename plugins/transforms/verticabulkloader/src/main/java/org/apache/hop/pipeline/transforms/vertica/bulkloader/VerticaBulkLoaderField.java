...
public class VerticaBulkLoaderField {
  ...
  @HopMetadataProperty(key = "stream_name", injectionKey = "STREAM_FIELDNAME", injectionKeyDescription = "VerticaBulkLoader.Inject.FIELDSTREAM")
  private String fieldStream;

  @HopMetadataProperty(key = "column_name", injectionKey = "DATABASE_FIELDNAME", injectionKeyDescription = "VerticaBulkLoader.Inject.FIELDDATABASE")
