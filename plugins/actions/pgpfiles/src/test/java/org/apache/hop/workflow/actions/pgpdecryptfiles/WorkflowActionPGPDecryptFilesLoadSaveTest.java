...
public class WorkflowActionPGPDecryptFilesLoadSaveTest extends WorkflowActionLoadSaveTestSupport<ActionPGPDecryptFiles> {
  ...
  protected List<String> listAttributes() {
    return Arrays.asList(
        ...
        "movedDateTimeFormat", "createMoveToFolder", "addMovedDate", "addMovedTime", "specifyMoveFormat", "addMovedDateBeforeExtension", "sourceFileFolder", "passphrase",
        "destinationFileFolder", "wildcard");
  }
