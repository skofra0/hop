...
public class BeamBQOutputTransformTest {
  ...
  public void testValidateBQFieldName() throws Exception {
    ...
    needsException(
        "_partition_", "no Exception thrown: BQ field name can't start with _partition_");
    needsException(
        "$name", "no Exception thrown: BQ field name only start with letters or underscore");
    needsException(
        "%name", "no Exception thrown: BQ field name only start with letters or underscore");
    needsException(
        "first name",
