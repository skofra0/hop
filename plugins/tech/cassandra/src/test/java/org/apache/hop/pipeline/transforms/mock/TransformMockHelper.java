...
public class TransformMockHelper<Meta extends ITransformMeta, Data extends ITransformData> {
  ...
  public final Meta processRowsITransformMeta;
  public final Data processRowsITransformData;
  public final ILogChannel logChannel;
  ...
  public TransformMockHelper(
    ...
    logChannel = mock(ILogChannel.class);
    ...
    processRowsITransformData = mock(transformDataClass);
    processRowsITransformMeta = mock(transformMetaClass);
  }
