...
public interface RelationshipCollisionListener {
  /**
   * When a relationship gets added and an existing relationship already exists, let the system know
   * what to do with the existing relationship. This is used to update or aggregate properties in
   * the existing data.
   *
   * @param existing
   * @param added
