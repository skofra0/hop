...
@GuiPlugin
public class NeoWorkflowExecutionViewerLineageTab extends NeoExecutionViewerLineageTab {
  private Tree wTree;
  ...
  public NeoWorkflowExecutionViewerLineageTab(WorkflowExecutionViewer viewer) {
    super(viewer);
  }
