...
public class NeoPipelineExecutionViewerCypherTab extends NeoExecutionViewerCypherTab {
  ...
  public NeoPipelineExecutionViewerCypherTab(PipelineExecutionViewer viewer) {
    super(viewer);
  }

  @GuiTab(id = "90010-pipeline-execution-viewer-neo4j-cypher-tab", parentId = PipelineExecutionViewer.PIPELINE_EXECUTION_VIEWER_TABS, description = "Neo4j Cypher")
  @Override
