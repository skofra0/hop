...
public class AzureFileSystem extends AbstractFileSystem implements FileSystem {

  private final BlobContainerAsyncClient blobContainerAsyncClient;
  private final BlobContainerClient blobContainerClient;

  protected AzureFileSystem(
      final AzureFileName rootName,
  ...
  protected FileObject createFile(AbstractFileName name) throws Exception {
    return new AzureFileObject(name, this);
  }

  @Override
  protected void addCapabilities(Collection<Capability> caps) {
    caps.addAll(AzureFileProvider.capabilities);
  }
}
