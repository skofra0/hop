 ...
 *
 * <p>This name should adhere to a URL structure, complete with an 'authority'
 *
 * <p>&lt;scheme&gt;://&lt;host_or_authority&gt;/&lt;container&gt;/&lt;file_path&gt; E.g.
 * azsb://myAccount.blob.core.windows.net/myContainer/path/to/file.txt
 */
public class AzureFileNameParser extends UrlFileNameParser {

  private static final AzureFileNameParser INSTANCE = new AzureFileNameParser();

  private AzureFileNameParser() {}
  ...
  public FileName parseUri(final VfsComponentContext context, final FileName base, final String uri)
    ...
    return new AzureFileName(scheme, account, container, absPath, fileType);
  }
}
