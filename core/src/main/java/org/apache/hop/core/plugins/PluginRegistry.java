...
public class PluginRegistry {
  ...
  public <T extends IPluginType> List<IPlugin> getPluginsByCategory(Class<T> pluginType, String pluginCategory) {
    List<IPlugin> plugins = getPlugins(pluginType).stream().filter(plugin -> plugin.getCategory() != null && plugin.getCategory().equals(pluginCategory)).collect(Collectors.toList());
