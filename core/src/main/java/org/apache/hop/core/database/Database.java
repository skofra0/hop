...
public class Database implements IVariables, ILoggingObject {
  ...
  private boolean canWeSetFetchSize(Statement statement) throws SQLException {
    return databaseMeta.isFetchSizeSupported() && (statement.getMaxRows() > 0 || databaseMeta.getIDatabase().isPostgresVariant() || (databaseMeta.isMySqlVariant() && databaseMeta.isStreamingResults()));
  }
  ...
  public void truncateTable(String schema, String tableName) throws HopDatabaseException {
    if (Utils.isEmpty(connectionGroup)) {
      ...
      execStatement("DELETE FROM " + databaseMeta.getQuotedSchemaTableCombination(this, schema, tableName));
    }
  }
  ...
  public String getDDLTruncateTable(String schema, String tableName) throws HopDatabaseException {
    if (Utils.isEmpty(connectionGroup)) {
      ...
      return ("DELETE FROM " + databaseMeta.getQuotedSchemaTableCombination(this, schema, tableName));
    }
  }
