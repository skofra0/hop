...
public interface IVariables {
  ...
  /**
   * Copy the variables from another IVariables object, without initializing with the defaults. This
   * does not affect any parent relationship.
   *
  ...
  /**
   * Share a variable variables from another IVariables. This means that the object should take over
   * the variables used as argument.
   *
  ...
  /**
   * This method returns a boolean for the new variable check boxes. If the variable name is not set
   * or the variable name is not specified, this method simply returns the default value. If not, it
   * convert the variable value to a boolean. "Y", "YES" and "TRUE" all convert to true. (case
   * insensitive)
   *
