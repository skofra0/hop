...
public class Metrics implements IMetrics {
  ...
  // Pipeline
  //
  public static Metrics METRIC_PIPELINE_EXECUTION_START = new Metrics(MetricsSnapshotType.START, "METRIC_PIPELINE_EXECUTION", "Execute a pipeline");
  public static Metrics METRIC_PIPELINE_EXECUTION_STOP = new Metrics(MetricsSnapshotType.STOP, "METRIC_PIPELINE_EXECUTION", "Execute a pipeline");
  public static Metrics METRIC_PIPELINE_INIT_START = new Metrics(MetricsSnapshotType.START, "METRIC_PIPELINE_INIT", "Initialize a pipeline");
  public static Metrics METRIC_PIPELINE_INIT_STOP = new Metrics(MetricsSnapshotType.STOP, "METRIC_PIPELINE_INIT", "Initialize a pipeline");
  public static Metrics METRIC_TRANSFORM_EXECUTION_START = new Metrics(MetricsSnapshotType.START, "METRIC_TRANSFORM_EXECUTION", "Execute a transform");
  public static Metrics METRIC_TRANSFORM_EXECUTION_STOP = new Metrics(MetricsSnapshotType.STOP, "METRIC_TRANSFORM_EXECUTION", "Execute a transform");
  public static Metrics METRIC_TRANSFORM_INIT_START = new Metrics(MetricsSnapshotType.START, "METRIC_TRANSFORM_INIT", "Initialize a transform");
  public static Metrics METRIC_TRANSFORM_INIT_STOP = new Metrics(MetricsSnapshotType.STOP, "METRIC_TRANSFORM_INIT", "Initialize a transform");

  // Logging back-end
  //
  public static Metrics METRIC_CENTRAL_LOG_STORE_TIMEOUT_CLEAN_TIME =
      new Metrics(MetricsSnapshotType.SUM, "METRIC_CENTRAL_LOG_STORE_TIMEOUT_CLEAN_TIME", "Time consumed removing old log records (ms)");
  public static Metrics METRIC_CENTRAL_LOG_STORE_TIMEOUT_CLEAN_COUNT =
      new Metrics(MetricsSnapshotType.COUNT, "METRIC_CENTRAL_LOG_STORE_TIMEOUT_CLEAN_COUNT", "Number of times removed old log records");
  public static Metrics METRIC_LOGGING_REGISTRY_CLEAN_TIME =
      new Metrics(MetricsSnapshotType.SUM, "METRIC_LOGGING_REGISTRY_CLEAN_TIME", "Time consumed removing old log registry entries (ms)");
  public static Metrics METRIC_LOGGING_REGISTRY_CLEAN_COUNT =
      new Metrics(MetricsSnapshotType.COUNT, "METRIC_LOGGING_REGISTRY_CLEAN_COUNT", "Number of times removed old log registry entries");
  public static Metrics METRIC_LOGGING_REGISTRY_GET_CHILDREN_TIME =
      new Metrics(MetricsSnapshotType.SUM, "METRIC_LOGGING_REGISTRY_GET_CHILDREN_TIME", "Time consumed getting log registry children (ms)");
  public static Metrics METRIC_LOGGING_REGISTRY_GET_CHILDREN_COUNT =
      new Metrics(MetricsSnapshotType.COUNT, "METRIC_LOGGING_REGISTRY_GET_CHILDREN_COUNT", "Number of times retrieved log registry children");

  // Workflow
  //
  public static Metrics METRIC_WORKFLOW_START = new Metrics(MetricsSnapshotType.START, "METRIC_JOB_EXECUTION", "Execute a workflow");
  public static Metrics METRIC_WORKFLOW_STOP = new Metrics(MetricsSnapshotType.STOP, "METRIC_JOB_EXECUTION", "Execute a workflow");
  public static Metrics METRIC_ACTION_START =
      new Metrics(
          ...
          "METRIC_JOBENTRY_EXECUTION",
          "Execute a action");
  // TODO: Rename METRIC_JOBENTRY_STOP to METRIC_ACTION_STOP
  public static Metrics METRIC_ACTION_STOP = new Metrics(MetricsSnapshotType.STOP, "METRIC_JOBENTRY_EXECUTION", "Execute a action");
