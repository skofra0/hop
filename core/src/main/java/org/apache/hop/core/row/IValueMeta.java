 ...
 * <td>The row value is an integer index into a fixed array of possible values. The IValueMeta object maintains
...
public interface IValueMeta extends Cloneable {
  ...
  IValueMeta getValueFromSqlType(IVariables variables, DatabaseMeta databaseMeta, String name, ResultSetMetaData rm, int index, boolean ignoreLength, boolean lazyConversion) throws HopDatabaseException;
