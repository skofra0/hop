...
public class GlobalMessageUtil {
  ...
  public static String calculateString(final String[] pkgNames, final String key, Object[] parameters, final Class<?> resourceClass, final String bundleName, final boolean fallbackOnRoot) {
  ...
  public static String calculateString(final String[] pkgNames, final String key, final Object[] parameters, final Class<?> resourceClass, final String bundleName, final boolean logNotFoundError, final boolean fallbackOnRoot) {
  ...
  private static String calculateString(final String[] pkgNames, final Locale locale, final String key, final Object[] parameters, final Class<?> resourceClass, final String bundleName, final boolean fallbackOnRoot) {
  ...
  @VisibleForTesting
  static String calculateString(final String packageName, final Locale locale, final String key, final Object[] parameters, final Class<?> resourceClass, final String bundleName, final boolean fallbackOnRoot) throws MissingResourceException {
    try {
  ...
  public static ResourceBundle getBundle(final String packagePath, final Class<?> resourceClass) throws MissingResourceException {
    ...
    final StringBuilder msg = new StringBuilder();
    msg.append("Unable to find properties file for package '").append(packagePath).append("' and class '").append(resourceClass.getName()).append("' in the available locales: ").append(List.of(activeLocales));
