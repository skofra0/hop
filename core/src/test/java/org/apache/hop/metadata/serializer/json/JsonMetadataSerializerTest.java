...
public class JsonMetadataSerializerTest extends TestCase {
  ...
  public void testPersonSerialization() throws HopException {
    ...
    Person person = new Person("Person", "51", new Address("Street", "123", new City("12345", "McCity")), new Music("Music", "Love Music"), Arrays.asList(new Cooking("Cooking", "Cooking is great"), new Running("Running", "Keep on running")), attributes, occupation1);
