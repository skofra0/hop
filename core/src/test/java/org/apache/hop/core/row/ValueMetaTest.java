...
public class ValueMetaTest {
  ...
  public void testLazyConversionNumber() throws Exception {
    ...
    // Get the binary data back : has to return exactly the same as we asked ONLY if the formatting
  ...
  public void testLazyConversionBigNumber() throws Exception {
    ...
    // NOTE This is obviously a number that is too large to fit into an Integer or a Number, but
