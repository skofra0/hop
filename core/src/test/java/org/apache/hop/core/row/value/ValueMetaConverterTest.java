  ...
  public void convertFromSourceToTargetDataTypeTest() throws Exception {
    ...
    Object[][] tests =
        new Object[][] {
            ...
            {IValueMeta.TYPE_STRING, IValueMeta.TYPE_BIGNUMBER, "123456789.123456789", new BigDecimal("123456789.123456789")},
            ...
            {IValueMeta.TYPE_BIGNUMBER, IValueMeta.TYPE_STRING, new BigDecimal("123456.123456"), "123456.123456"},
            {IValueMeta.TYPE_BIGNUMBER, IValueMeta.TYPE_NUMBER, new BigDecimal("123456.123456"), 123456.123456d},
            {IValueMeta.TYPE_BIGNUMBER, IValueMeta.TYPE_BIGNUMBER, new BigDecimal("123456.123456"), new BigDecimal("123456.123456")},
