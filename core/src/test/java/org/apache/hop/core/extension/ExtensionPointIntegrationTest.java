...
public class ExtensionPointIntegrationTest {
  ...
  private static Class createClassRuntime(HopExtensionPoint ep, String addition) throws NotFoundException, CannotCompileException {
    ...
    ctClass.addMethod(CtNewMethod.make("public void callExtensionPoint( org.apache.hop.core.logging.ILogChannel log, org.apache.hop.core.variables.IVariables variables, Object object ) " + "throws org.apache.hop.core.exception.HopException { " + EXECUTED_FIELD_NAME + " = true; }", ctClass));
  ...
  private static void assertConcurrent(final List<? extends Runnable> runnables) throws InterruptedException {
    ...
    try {
      ...
      assertTrue("Timeout initializing threads! Perform long lasting initializations before passing runnables to assertConcurrent", allExecutorThreadsReady.await(10L * runnables.size(), TimeUnit.MILLISECONDS));
